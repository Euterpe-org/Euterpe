...
public interface IChartManageService
{
    ...
    Task<int> MigrateCustomAlbumFilesAsync(IReadOnlyList<string> filePaths, IProgress<BatchProgress>? progress = null, CancellationToken cancellationToken = default);
