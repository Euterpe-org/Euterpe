...
public static class DependencyConstants
{
    public static class MelonLoader
    {
        ...
        public const string Url = $"{Dependencies.BaseUrl}MelonLoader/{Version}/MelonLoader.x64.zip";
    ...
    public static class UnityRuntime
    {
        ...
        public const string Url = $"{Dependencies.BaseUrl}UnityDependencies/{Version}/Managed.zip";
    ...
    public static class Cpp2IL
    {
        ...
        public const string ExecutableUrl = $"{Dependencies.BaseUrl}Cpp2IL/{Version}/Cpp2IL-{Version}-Windows.exe";
        public const string PluginUrl = $"{Dependencies.BaseUrl}Cpp2IL/{Version}/Cpp2IL.Plugin.StrippedCodeRegSupport.dll";
